...
def split_X_y(data, columns_x, columns_y, normalize_X = True):
...
### MAIN ###
############
def main(data, columns_x, columns_y, holdout_days, normalize_X = True):
    ...
    [X_test, y_test] = split_X_y(data = data_test, columns_x = columns_x, columns_y = columns_y, normalize_X = normalize_X)
