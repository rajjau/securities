...
### CUSTOM MODULES ###
######################
from modules.apply_feature_selection import main as apply_feature_selection
...
def main(X_train, y_train, X_test, columns_x, random_seeds, configuration_ini):
    ...
    X_train, X_test, _ = apply_feature_selection(X_train=X_train, X_test=X_test, selected_features=selected_features.index, verbose=True)
