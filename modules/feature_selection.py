...
def main(X_train, y_train, X_test, feature_names):
    ...
    # Use VarianceThreshold with the default threshold to remove features from $X_train that have zero variance.
    ...
    # Perform feature selection using SelectKBest based on mutual information between $X_train and $y_train.
    selected_features = select_k_best(X=X_train, y=y_train, feature_names=X_train.columns, k=10)
